    ...
    <DefaultLayout>
        ...
        <DefaultAuthCard subtitle="Start for free" title="Sign Up">
            <form @submit.prevent="submit">
                <InputGroup label="Name" id="name" type="text" placeholder="Enter your full name" v-model="form.name"
                ...
                <InputGroup label="Email" type="email" placeholder="Enter your email" v-model="form.email" id="email"
                ...
                <InputGroup label="Password" type="password" id="password" placeholder="Enter your password"
