...
const props = defineProps(['id', 'label', 'type', 'placeholder', 'modelValue'])
...
<template>
  <div class="mb-4">
    <label :for="props.id" class="mb-2.5 block font-medium text-black dark:text-white">{{ props.label }}</label>
    <div class="relative">
      <input
        :id="props.id"
        :type="props.type"
